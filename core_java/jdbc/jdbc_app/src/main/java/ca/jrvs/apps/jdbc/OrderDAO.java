...
public class OrderDAO extends DataAccessObject<Order> {
    ...
    public Order findById(long id) {
        ...
        try (PreparedStatement statement = this.connection.prepareStatement(GET_BY_ID);) {
            ...
            // Loop over resultset and add all orders to orderline array
            while (resultSet.next()) {

                // OrderId is 0, dealing with new order, set order info
                if (orderId == 0) {
                ...
                // Add order item info to orderLine array
            ...
            // Set order orderLines to array of info
